...
const TechExpertiseSection = () => {
  return (
    <div className="flex items-center justify-between w-full bg-red-50 p-16">
      {/* Left Content */}
      <div className="w-1/2">
        ...
        <h2 className="text-4xl font-bold mt-4 mb-6">
          ...
          <span className="text-red-500">Achieve Success</span>
        </h2>
        
        <div className="flex gap-4 mb-8">
          <span className="text-red-500 font-medium">Web Development</span>
...
<div className="w-1/2 relative  pr-8"> {/* Added right padding */}
  <div className="absolute inset-0 transform -translate-y-0.5"> {/* Moved up slightly */}
    <div className="w-3/4 h-3/4 mx-auto bg-red-100 rounded-full"></div> {/* Made circle smaller (3/4 of original) */}
  </div>
