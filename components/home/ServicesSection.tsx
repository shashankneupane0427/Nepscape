    ...
    <div className="w-full py-16 px-4 md:px-8 bg-white font-poppins">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
        {services.map((service) => (
          <div 
            key={service.id} 
            className="flex flex-col items-center text-center p-6 rounded-lg transition-all duration-300 hover:bg-red-50 hover: cursor-pointer group font-poppins"
          >
...
const WebsiteIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:animate-bounce">
...
const AppDevIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:rotate-6">
...
const SoftwareIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:-rotate-6">
    ...
    <circle cx="75" cy="40" r="15" fill="rgba(239, 68, 68, 0.3)" className="group-hover:scale-110 origin-center transition-transform duration-300" />
    <rect x="65" y="58" width="5" height="12" fill="#EF4444" className="group-hover:translate-y-1 transition-transform duration-300" />
    <rect x="75" y="53" width="5" height="17" fill="#EF4444" className="group-hover:translate-y-2 transition-transform duration-500" />
    <rect x="85" y="50" width="5" height="20" fill="#EF4444" className="group-hover:translate-y-1 transition-transform duration-700" />
  </svg>
);

const UiUxIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:scale-105">
    <rect x="20" y="25" width="35" height="50" rx="3" fill="white" stroke="#EF4444" strokeWidth="2" className="group-hover:translate-x-1 transition-transform duration-300" />
    ...
    <rect x="45" y="40" width="30" height="45" rx="3" fill="rgba(239, 68, 68, 0.15)" stroke="#EF4444" strokeWidth="2" className="group-hover:translate-x-1 transition-transform duration-500" />
...
const SeoIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:rotate-12">
    ...
    <circle cx="50" cy="50" r="15" fill="white" stroke="#EF4444" strokeWidth="2" className="group-hover:scale-110 origin-center transition-transform duration-300" />
    <path d="M50 42 L50 58" stroke="#EF4444" strokeWidth="2" className="group-hover:rotate-90 origin-center transition-transform duration-500" />
    <path d="M42 50 L58 50" stroke="#EF4444" strokeWidth="2" />
    <circle cx="70" cy="70" r="5" fill="#EF4444" className="group-hover:scale-125 origin-center transition-transform duration-300" />
...
const SmmIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:-rotate-6">
    ...
    <path d="M45 45 L55 50 L45 55 Z" fill="#EF4444" className="group-hover:translate-x-1 transition-transform duration-300" />
    <circle cx="50" cy="75" r="3" stroke="#EF4444" strokeWidth="2" fill="white" />
    <path d="M75 40 C85 45 85 55 75 60" stroke="#EF4444" strokeWidth="2" className="group-hover:translate-x-1 transition-transform duration-500" />
    <path d="M80 35 C95 42 95 58 80 65" stroke="#EF4444" strokeWidth="2" className="group-hover:translate-x-2 transition-transform duration-700" />
  </svg>
);
...
const GraphicDesignIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:scale-105">
    ...
    <circle cx="35" cy="35" r="10" fill="white" stroke="#EF4444" strokeWidth="2" className="group-hover:scale-110 origin-center transition-transform duration-300" />
    <rect x="50" y="25" width="20" height="20" rx="2" fill="white" stroke="#EF4444" strokeWidth="2" className="group-hover:rotate-12 origin-center transition-transform duration-500" />
    <path d="M25 55 L45 55 L35 75 Z" fill="white" stroke="#EF4444" strokeWidth="2" className="group-hover:translate-y-1 transition-transform duration-300" />
    <rect x="50" y="55" width="20" height="20" rx="2" fill="#EF4444" className="group-hover:-rotate-12 origin-center transition-transform duration-500" />
    <circle cx="75" cy="35" r="5" fill="#EF4444" className="group-hover:scale-125 origin-center transition-transform duration-300" />
  </svg>
);
...
const ContentWritingIcon: React.FC = () => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-all duration-300 group-hover:scale-105">
    ...
    <rect x="30" y="30" width="40" height="3" rx="1" fill="#EF4444" className="group-hover:translate-x-1 transition-transform duration-300" />
    ...
    <circle cx="75" cy="75" r="10" fill="rgba(239, 68, 68, 0.3)" className="group-hover:scale-110 origin-center transition-transform duration-300" />
  </svg>
);
